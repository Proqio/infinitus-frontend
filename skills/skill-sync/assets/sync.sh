...
get_agents_path() {
    local scope="$1"
    case "$scope" in
        frontend)       echo "$REPO_ROOT/AGENTS.md" ;;
        ui)         echo "$REPO_ROOT/src/components/AGENTS.md" ;;
        api)        echo "$REPO_ROOT/src/api/AGENTS.md" ;;
        test) echo "$REPO_ROOT/src/tests/AGENTS.md" ;;
        *)          echo "" ;;
    esac
}
